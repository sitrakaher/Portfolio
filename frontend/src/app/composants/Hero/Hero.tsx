    ...
    <div className={`flex items-center lg:p-20 md:p-10  justify-center md:border-2 md:border-cyan-600 rounded-2xl md:shadow-lg md:shadow-cyan-900 transition-transform duration-800 ease-out ${visible ?"md:translate-y-0" : "md:-translate-y-full"}`}>
      ...
      <div className="flex-3 flex flex-col items-center justify-center">
          <div className='flex flex-col gap-10 justify-between'>
              ...
              <Link href="/file/CV_Rakotoarivony_Sitraka_Heriniaina_Developpeur_Full_Stack_JavaScript_Junior.pdf" download className='bg-linear-to-r from-cyan-600 to-cyan-300 flex items-center justify-center flex-row-reverse gap-2 hover:scale-105 px-6 py-2 rounded md:w-fit text-center text-white shadow-cyan-300 shadow-2xl'>
